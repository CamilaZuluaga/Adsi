...
<body>
	...
	<section class="wave-contenedor website">
		...
		<div class="contenedor-textos-main">
            ...
            <br><br>
 		    En el momento en el que el cliente elija el paquete que más se adapta a sus necesidades, podrá seleccionar también una de las tantas empresas que aparecerán como opción. Una vez que el cliente haya adquirido el servicio, si lo desea, podrá entonces realizar un comentario y calificarlo.</p>
	...
	<section class="info">
		<div class="contenedor">
			<h2 class="titulo left">¿A quién nos dirigimos?</h2>
			...
			<section id="quienes-somos" class="info-last">
				<div class="contenedor last-section">
					<div class="contenedor-textos-main">
						...
						<p>Somos un equipo de programadoras que trabaja arduamente por lograr sus metas; sin experiencia laboral pero con ganas de aprender constantemente y de ser emprendedoras.
						</p>
						<br>
						<a href="" class="cta">Subir</a>
					</div>
